...
#    Then close the application
  ...
  @api
  Scenario Outline: Reading data with api
    Given user sets all response using api end point "<resource>"
    And user deserializes "<parameter>" data as json to java pojo
#    Then user validates the "<parameter>" data    Examples: Api parameters
    Examples:
      | parameter | resource     |
      | customer  | tp-customers |
      | country   | tp-countries |
