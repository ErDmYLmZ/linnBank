...
#
#    Examples:
#      | ssn         | firstname | lastname | address | mobilephone  | username    | email           | firstPassword | secondPassword | AssertType
#      | 700-54-7402 | claire    | black    | antalya | 505-123-0000 | claireblack | c123b@gmail.com | c123b         | c123b          | True
